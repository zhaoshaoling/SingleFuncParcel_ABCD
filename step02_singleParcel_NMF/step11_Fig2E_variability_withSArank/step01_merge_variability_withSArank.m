...
medial_wall_label_left=find(left_temp~=0);% index nonzero
...
BD1=1:59412;
BD2=BD1.';
% generate csv file and set VariableNames
result_table=table(BD2, weight_gradient(:,1), weight_gradient(:,2), 'VariableNames', title);

%%%
writetable(result_table,[working_dir '/acrossSubject_variability/acrossSubjectVariability_SAgradient32k_n3198.csv']);
