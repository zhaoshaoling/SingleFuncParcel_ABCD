function SpinPermuFS(readleft,readright,permno)
...
datal=importdata(readleft);  % .data() part may or may not be needed
datar=importdata(readright); % .data() part may or may not be needed
...
[vl, left_labels, ctl] = read_annotation('/ibmgpfs/cuizaixu_lab/zhaoshaoling/SHW/IFN/code/CBIG-master/data/templates/surface/fs_LR_32k/label/lh.aparc.annot');


%datal(left_labels==1644825)=NaN;
datal(left_labels==14474380)=NaN;


% right:
%[vr,right_labels,ctr] = read_annotation(fullfile(fshome,'/subjects/fsaverage5/label/rh.aparc.a2009s.annot'));
[vr,right_labels,ctr] = read_annotation('/ibmgpfs/cuizaixu_lab/zhaoshaoling/SHW/IFN/code/CBIG-master/data/templates/surface/fs_LR_32k/label/rh.aparc.annot');

%datar(right_labels==1644825)=NaN;
datar(right_labels==14474380)=NaN;
...
[verticesl, ~] = freesurfer_read_surf('/ibmgpfs/cuizaixu_lab/zhaoshaoling/SHW/IFN/code/CBIG-master/data/templates/surface/fs_LR_32k/surf/lh.sphere');
[verticesr, ~] = freesurfer_read_surf('/ibmgpfs/cuizaixu_lab/zhaoshaoling/SHW/IFN/code/CBIG-master/data/templates/surface/fs_LR_32k/surf/rh.sphere');
...
for j=1:permno
    ...
    %save rotated data
    shuffledLeft=datal(:, Il ,:);
    shuffledRight=datar(:, Ir ,:);
...
%     wsname = ['/ibmgpfs/cuizaixu_lab/suhaowen/n3871/replication_ZSL/step00_topography/code4mshbm/atlas_reliability/SpinTest/permList/Perm_',num2str(j),'_atlasReliability.mat'];
    wsname=['/ibmgpfs/cuizaixu_lab/zhaoshaoling/NMF_NeuronCui/ABCD_indivTopography/step01_NMFtopography/code4mshbm/atlas_reliability/SpinTest/permList/Perm_',num2str(j),'_atlasReliability.mat'];
    save(wsname,"shuffledLeft","shuffledRight",'-v7.3')
end
