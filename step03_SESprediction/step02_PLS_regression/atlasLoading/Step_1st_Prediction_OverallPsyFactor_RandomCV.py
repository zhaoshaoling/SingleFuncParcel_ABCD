...
import os
import sys
sys.path.append('/ibmgpfs/cuizaixu_lab/zhaoshaoling/NMF_NeuronCui/replication_ZSL/step01_prediction/PLS_regression/NMF_n3198/CovariatesControlled/zaixu/');
import PLSr1_CZ_Random_RegressCovariates

ResultsFolder = '/ibmgpfs/cuizaixu_lab/zhaoshaoling/NMF_NeuronCui/replication_ZSL/step01_prediction/PLS_regression/NMF_n3198/CovariatesControlled/zaixu/results';
# Import data
# 1. atlas loading
datapath = '/ibmgpfs/cuizaixu_lab/zhaoshaoling/NMF_NeuronCui/step02_prediction/ridge_regression/AtlasLoading_fsaverage5/AtlasLoading_All_RemoveZeros_n3198.txt';
