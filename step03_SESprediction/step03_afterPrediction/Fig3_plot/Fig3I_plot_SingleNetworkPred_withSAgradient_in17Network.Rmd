...
Weight_Overall<-read.csv("/Users/zhaoshaoling/Documents/ABCD_indivTopography/step02_SESprediction/gradient/network17_singleNetworkPred_SAgradient_n3198.csv",header = F)
...
fig1 <- ggplot(data=Weight_Overall, aes(y=Number, x=Gradient,size=8))+ 
  ...
  theme(axis.title.x = element_text(size = 20))+ xlab("Sensory-to-Association Gradient") + theme(axis.title.y = element_text(size = 20))+
...
ggsave('/Users/zhaoshaoling/Documents/ABCD_indivTopography/FiguresPlot/zaixu/Figs/singleNetwork_PredACC_SAgradient_n3198_new1101.pdf', width = 19, height = 15, dpi = 600, units = "cm",device = "pdf")
