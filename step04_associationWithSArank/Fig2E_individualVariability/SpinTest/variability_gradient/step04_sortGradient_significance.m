%%
clear
working_dir='/ibmgpfs/cuizaixu_lab/zhaoshaoling/NMF_NeuronCui/n3871/replication_ZSL/step01_prediction/gradient_NMF/gradient';
...
Index_l=find(left_temp~=0);%non zero index
Index_r=find(right_temp~=0); 
% Index=[Index_l' Index_r']';

table_variability=readtable([working_dir '/acrossSubjects_variability/SpinTest/variability_gradient/acrossSubjectVariability_SAgradient_deNaN_n3198.csv']);%%num, variability, gradient
...
Perm_data = load([working_dir '/acrossSubjects_variability/SpinTest/variability_gradient/acrossSubjectVariability_gradient_n3198_Perm.mat']);
...
% save([SpinTest_Folder '/variability_gradient_AllData_n3198.mat'], ...
